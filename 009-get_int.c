...
int get_buffer_len(unsigned int num, unsigned int base);
...
/**
 * get_buffer_len - gets length of buffer needed for an unsigned int
 * @num: number to get length needed for
 * @base: base of number representation used by buffer
 * Return: integer containing length of buffer needed
 * doesn't contain null byte
 */
int get_buffer_len(unsigned int num, unsigned int base)
{
	int len = 1;
...
/**
 * fill_buffer - fills buffer with correct numbers up to base 36
